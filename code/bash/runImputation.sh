...
# =========================================================================== #
  ...
  # Reference
  REFDIR=$3 # directory with 1000 genomes information, included population
...
# =========================================================================== #
  ...
  for LINE in $CONLIST ; do 
    ...
    for INV in $INVLIST; do # For each inversion
      ...
      # =========================================================================== #
        STEP=$((${STEP}+1))
        echo "## ${STEP} REFERENCE FILE: 1KGP + Inversion in this pop. individuals ####"
