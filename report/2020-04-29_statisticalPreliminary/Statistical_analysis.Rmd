...
# Chromosome 21 test
chromosome<-"chr11"
test2<-crossovers_raw[crossovers_raw$chr == chromosome & crossovers_raw$pos.rightbound < 80000000,]
invs<-coords[coords$V1 == chromosome & coords$V5 < 80000000,]
invs


341, 760, 275, 276

geno[geno$Var2 == "HsInv0209", ]

ggplot(test2)+geom_rect(aes(xmin=pos.leftbound, xmax=pos.rightbound, ymin = 0, ymax = 1), alpha = 0.002)+
  geom_rect(data=invs, aes(xmin = V4, xmax = V5, ymin = 0.25, ymax = 0.75), fill = "red")
...
crossovers_raw$buffer<-crossovers_raw$resolution/8
