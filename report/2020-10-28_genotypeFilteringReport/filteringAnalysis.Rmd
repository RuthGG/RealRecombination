...
```{r, include = FALSE}
 ...
 # Individual genotypes
   # Get individuals genotypes
    genotypes<-read.table("../../analysis/2020-12-14_07_imputationTables/imputationResults.csv", header=TRUE, sep = ",")
...
genotypes[genotypes$STEP04.general.filter == "FILTERED", "accepted_genotype"]<-NA
```
...
* INVERIONS STEP05: those inversions with more than 3 individuals genotyped and with both heterozygous and homozygous individuals available (62).

* INVERIONS STEP06 = STEP04 int. STEP05: autosomal imputable good quality genotyped inverisons (62)
...
test<-test[test$STEP02.has.imp.info == "PASS",]

write.csv(test, file = " inversions_filtered.csv")
write.csv(genotypes, file = " genotypes_filtered.csv")


```

# Tag SNPs direct inference

We had tagSNPs for n inversions. Some of them had global and metapopulatoin tagSNPs (GLB, EUR, AFR) and some of them has proxy populations (CEU, CHB). 

# Coverage check

I checked how many SNPs that are in 1/40 and 1/20 chromosomes are present in our dataset, for regions inside inversions and inversion +- 500kb (imputation region). 
