...
```{r impute2, echo =FALSE}
 ...
 # LOAD IMPUTE2 RESULTS
   # Get individuals genotypes
    ...
    genotypes_HsInv0501<-read.table("../../analysis/2021-02-17_07_imputationTables_HsInv0501/new_genotypes.csv", header=TRUE, sep = "\t", stringsAsFactors = FALSE)
