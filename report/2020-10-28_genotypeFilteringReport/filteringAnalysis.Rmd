...
Only those results with TagSNP.probability >= 0.8 were accepted. 
<!-- **`r nrow(tagtab_summary[tagtab_summary$TagSNP.probability >=0.8,])` out of `r nrow(tagtab_summary)` inversion-individual pairs had valid tag SNP-mediated imputation results available**.  -->
...
* **Good tagSNP results:** those cases with a tag SNP-mediated imputation result showing a TagSNP.probability >= 0.8.
